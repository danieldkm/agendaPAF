...
public class EmpresaController extends FXMLController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        try {
            ...
            mainEmpresa.setOnKeyReleased(new EventHandler<KeyEvent>() {
                @Override
            ...
            addEstado();
//            cbEstado.setOnAction(new EventHandler() {
//
//                @Override
    ...
    private void actionBtnDeletar() {
        try {
            if (empresaEncontrada != null) {
                ...
                utilDialog.criarDialogInfomation(EnumMensagem.Padrao.getTitulo(), EnumMensagem.Padrao.getSubTitulo(), EnumMensagem.EmpresaErroNaoExisteEmpresa.getMensagem());
            }
        } catch (Exception e) {
            JPA.em(false).close();
            utilDialog.criarDialogException(EnumMensagem.Padrao.getTitulo(), EnumMensagem.Padrao.getSubTitulo(), EnumMensagem.EmpresaErroTentarDeletar.getMensagem() + empresaEncontrada.getId(), e, "Exception");
