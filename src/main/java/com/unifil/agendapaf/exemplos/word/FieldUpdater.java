...
/**
 * Refreshes the values of certain fields in the docx (currently DOCPROPERTY
 * only).
 *
 * Do this whether they are simple or complex.
 *
 * This updates the docx. If you don't want to do that, apply it to a clone
 * instead.
 *
 * @author jharrop
 *
...
//							fr.getParent(), true, true));
    ...
    public static void main(String[] args) throws Docx4JException {
        ...
        WordprocessingMLPackage wordMLPackage = WordprocessingMLPackage.load(
                new java.io.File("modelo/a.docx"));
